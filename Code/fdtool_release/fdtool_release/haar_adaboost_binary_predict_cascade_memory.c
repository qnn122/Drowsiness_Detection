...
/*
  ...
  [yest , fx] = haar_adaboost_binary_predict_cascade_memory(X , [options]);
  ...
  mex  -output haar_adaboost_binary_predict_cascade_memory.dll haar_adaboost_binary_predict_cascade_memory.c

  mex  -f mexopts_intel10.bat -output haar_adaboost_binary_predict_cascade_memory.dll haar_adaboost_binary_predict_cascade_memory.c
 ...
 H                            = mblbp(H , options);
 [yest , fx]                  = haar_adaboost_binary_predict_cascade_memory(z , options);

 options.cascade              = [10 , 10 ; 0 , 0];

 [yest_cascade , fx_cascade]  = haar_adaboost_binary_predict_cascade_memory(z , model.param , [] , cascade);
 ...
 [yest , fx]             = haar_adaboost_binary_predict_cascade_memory(H , model);
...
void  adaboost_binary_model_cascade(float * , int , int , struct opts , char * , double *);
...
/*----------------------------------------------------------------------------------------------------------------------------------------- */
void  adaboost_binary_model_cascade(float *X , int d , int N , struct opts options , char *yest, double *fx)									
{
