...
/*
  ...
  [yest , fx] = haar_gentleboost_binary_predict_cascade_memory(X , [options]);
  ...
  mex  -g -output haar_gentleboost_binary_predict_cascade_memory.dll haar_gentleboost_binary_predict_cascade_memory.c
  mex  -output haar_gentleboost_binary_predict_cascade_memory.dll haar_gentleboost_binary_predict_cascade_memory.c
  mex  -f mexopts_intel10.bat -output haar_gentleboost_binary_predict_cascade_memory.dll haar_gentleboost_binary_predict_cascade_memory.c
  ...
  [yest , fx]             = haar_gentleboost_binary_predict_cascade_memory(X , options);
  [yest1 , fx1]           = haar_gentleboost_binary_predict_cascade_memory(X , options);
 ...
 I                       = X(: , : , Nimage);
 z                       = mblbp(I , F);
 [yest , fx]             = haar_gentleboost_binary_predict_cascade_memory(z , model.param , [] , cascade);
 [yest1 , fx1]           = haar_gentleboost_binary_predict_cascade_memory(z , model.param);
...
void  gentleboost_binary_model_cascade(float * , int , int , struct opts , char * , double *);
/*-------------------------------------------------------------------------------------------------------------- */
...
/*----------------------------------------------------------------------------------------------------------------------------------------- */
void  gentleboost_binary_model_cascade(float *X , int d , int N , struct opts options , char *yest, double *fx)
{
